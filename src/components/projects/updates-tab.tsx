...
import { useProjectDprs, useProjectInstructions, useProjectActivityLog, useStore } from "@/lib/store/project-store";
...
export function UpdatesTab({ projectId }: { projectId: string }) {
  ...
  const activityLog = useProjectActivityLog(projectId);
